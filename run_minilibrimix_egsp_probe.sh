...
run_probe mini_exp14_egsp_tokens_s025 \
  --override model.egsp_enabled=true \
  --override model.egsp_strength=0.25 \
  --override model.egsp_apply_to_spec=false

run_probe mini_exp15_egsp_tokens_s050 \
  --override model.egsp_enabled=true \
  --override model.egsp_strength=0.50 \
  --override model.egsp_min_weight=0.60 \
  --override model.egsp_max_weight=1.40 \
  --override model.egsp_apply_to_spec=false

run_probe mini_exp16_egsp_spec_s015 \
  --override model.egsp_enabled=true \
  --override model.egsp_strength=0.15 \
...
methods = [
    ...
    "mini_exp14_egsp_tokens_s025",
    "mini_exp15_egsp_tokens_s050",
    "mini_exp16_egsp_spec_s015",
]
main_rows = []
eff_rows = []
...
for filename, rows in [
    ("results/summary_mini_egsp_probe_main.csv", main_rows),
    ("results/summary_mini_egsp_probe_efficiency.csv", eff_rows),
]:
...
print(Path("results/summary_mini_egsp_probe_main.md").read_text(encoding="utf-8"))
print("\n--- efficiency ---")
print(Path("results/summary_mini_egsp_probe_efficiency.md").read_text(encoding="utf-8"))
PY
